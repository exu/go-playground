...
// for example with worker pools. There are a few other options for managing state
// though. Here we’ll look at using the sync/atomic package for atomic counters accessed by
// multiple goroutines.
...
func main() {
	...
	// To simulate concurrent updates, we’ll start 50 goroutines that each increment the
