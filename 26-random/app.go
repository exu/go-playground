...
func main() {
	...
	// This can be used to generate random floats in other ranges, for example 5.0 <= f' <
	// 10.0.
	...
	// If you seed a source with the same number, it produces the same sequence of random
	// numbers.
