...
func main() {
	...
	// Format uses an example-based layout approach; it takes a formatted version of the
	// reference time Mon Jan 2 15:04:05 MST 2006 to determine the general pattern with which
	// to format the given time. The example time must be exactly as shown: the year 2006, 15
	// for the hour, Monday for the day of the week, etc. Here are a few more examples of
	// time formatting.
	...
	// Time parsing uses the same example-based approach as Formating. These examples parse
	// times rendered with some of the layouts used above.
