...
func main() {
	...
	// By blocking on a receive from the limiter channel before serving each request, we
	...
	// Every 200 milliseconds we’ll try to add a new value to burstyLimiter, up to its limit
	// of 3.
...
// Running our program we see the first batch of requests handled once every ~200
